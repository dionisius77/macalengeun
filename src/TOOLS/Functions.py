...
def checkIfChar(possibleChar):
    if ((possibleChar.boundingRectArea < 11000 and possibleChar.boundingRectArea > 10)):
    ...
    #         and possibleChar.boundingRectHeight > 8 and 0.25 < possibleChar.aspectRatio < 1.0):
        # print(possibleChar.boundingRectArea)

        return True
    else:
        return False

def checkIfCharData(possibleChar):
    if ((possibleChar.boundingRectArea < 11000 and possibleChar.boundingRectArea > 10)):
    # if (possibleChar.boundingRectArea > 80 and possibleChar.boundingRectWidth > 2
    #         and possibleChar.boundingRectHeight > 8 and 0.25 < possibleChar.aspectRatio < 1.0):
        # print(possibleChar.boundingRectArea)
        ...
        return {
            "boundingRectArea": possibleChar.boundingRectArea,
            "boundingRectWidth": possibleChar.boundingRectWidth,
            "boundingRectHeight": possibleChar.boundingRectHeight,
            "centerX": possibleChar.centerX,
            "centerY": possibleChar.centerY,
            "boundingRect": possibleChar.boundingRect,
            "diagonalSize": possibleChar.diagonalSize
        }
